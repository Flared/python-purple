...
cdef extern from "libpurple/util.h":
    ...
    ctypedef struct PurpleMenuAction:
        char *label
        c_libsignals.PurpleCallback callback
        glib.gpointer data
        glib.GList *children
    ...
    PurpleMenuAction *purple_menu_action_new(
        char *label,
        c_libsignals.PurpleCallback callback,
        glib.gpointer data,
        glib.GList *children
    ...
    char *purple_util_format_song_info(
        char *title,
        char *artist,
        char *album,
        glib.gpointer unused
    )
...
#            char **start, char **end, glib.GData **attributes)
    glib.gboolean purple_markup_extract_info_field(
        char *str,
        int len,
        ...
        char *no_value_token,
        char *display_name,
        glib.gboolean is_link,
        char *link_prefix,
        PurpleInfoFieldFormatCallback format_cb
    )

    void purple_markup_html_to_xhtml(
        char *html,
        char **dest_xhtml,
        char **dest_plain
    )
    ...
    glib.gboolean purple_util_write_data_to_file(
        char *filename,
        char *data,
        glib.gssize size
    )

    glib.gboolean purple_util_write_data_to_file_absolute(
        char *filename_full,
        char *data,
        glib.gssize size
    )

    c_libxmlnode.xmlnode *purple_util_read_xml_from_file(char *filename, char *description)
    ...
    char *purple_normalize(
        c_libaccount.PurpleAccount *account,
        char *str
    )

    char *purple_normalize_nocase(
        c_libaccount.PurpleAccount *account,
        char *str
    )
    ...
    void purple_util_chrreplace(
        char *string,
        char delimiter,
        char replacement
    )

    glib.gchar *purple_strreplace(
        char *string,
        char *delimiter,
        char *replacement
    )
    ...
    glib.gchar *purple_strcasereplace(
        char *string,
        char *delimiter,
        char *replacement
    )
    ...
    glib.gboolean purple_url_parse(
        char *url,
        char **ret_host,
        int *ret_port,
        char **ret_path,
